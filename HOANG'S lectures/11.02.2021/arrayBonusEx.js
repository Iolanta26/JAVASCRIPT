...
const currentArray = [band.members.current];
console.log(currentArray);

const pastArray = [band.members.past];
console.log(pastArray);

const combineArray = currentArray.concat(pastArray);
console.log(combineArray);

// console.log();

// combineArray.sort((a, b) => {
//   return b.age - a.age;
// });

// MAP  метод в конце возвращает данные в отделбный эррей
